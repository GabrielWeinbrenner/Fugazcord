  ...
  return (
    <Layout heading="Create an Account">
      <Form onSubmit={handleSubmit}>
        ...
        <Label error={usernameError} htmlFor="username">
          Username
          {usernameError && (
            <span className="errorMessage"> - {usernameError}</span>
          )}
        </Label>
        <Input type="text" name="username" error={usernameError} id="username" />
        ...
        <Input type="password" name="password" error={passwordError} id="password" />
